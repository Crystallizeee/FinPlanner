...
use App\Livewire\CashflowPredictorComponent;
...
use App\Livewire\ExchangeRatesComponent;
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/cashflow-predictor', CashflowPredictorComponent::class)->name('cashflow-predictor');
    Route::get('/wishlist', WishlistComponent::class)->name('wishlist');
    Route::get('/exchange-rates', ExchangeRatesComponent::class)->name('exchange-rates');
